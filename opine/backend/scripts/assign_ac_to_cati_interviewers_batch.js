...
/**
 * Assign ACs to CATI Interviewers Script (Batch)
 * 
 * This script assigns ACs to multiple CATI interviewers by member ID
 * 
 * Usage:
 *   node assign_ac_to_cati_interviewers_batch.js
 */
...
const MEMBER_IDS = ['703', '704', '705', '706', '707', '708', '709', '710', '711', '712', '713', '714', '715'];
...
async function main() {
  try {
    ...
    console.log('ASSIGN ACs TO CATI INTERVIEWERS (BATCH)');
    console.log('='.repeat(70));
