...
/**
 * Master Script to Process All AC Contact Files
 * 
 * This script processes all CSV files in the newcontacts folder:
 * 1. Extracts AC code from filename (e.g., ac292.csv -> 292)
 * 2. Looks up AC name from assemblyConstituencies.json (WB292)
...
// Constants
const NEWCONTACTS_DIR = '/var/www/Report-Generation/newcontacts';
...
/**
 * Extract AC code from filename (e.g., ac292.csv -> 292)
 */
...
async function main() {
  console.log('='.repeat(70));
  console.log('MASTER AC CONTACTS PROCESSING SCRIPT');
  console.log('='.repeat(70));
  ...
  // Save summary JSON
  const summaryPath = path.join(OUTPUT_DIR, `ac_contacts_processing_summary_${Date.now()}.json`);
