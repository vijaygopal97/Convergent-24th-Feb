...
router.get('/survey/:surveyId/responses-v2', protect, authorize('company_admin', 'project_manager', 'state_manager'), getSurveyResponsesV2);

// Get response counts (lightweight endpoint for counts only)
router.get('/survey/:surveyId/responses-v2/counts', protect, authorize('company_admin', 'project_manager', 'state_manager'), getSurveyResponseCounts);
