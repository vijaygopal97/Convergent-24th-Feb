...
const QualityManagerSurveyReports = () => {
  ...
  const handleViewQCPerformance = (survey) => {
    navigate(`/quality-manager/surveys/${survey._id || survey.id}/qc-performance`);
  };
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-600 mt-1">View QC performance for your company surveys</p>
      </div>
                    ...
                    <tr key={survey._id || survey.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-4 py-4 whitespace-nowrap text-right text-sm font-medium">
                        <div className="flex flex-col items-end space-y-2">
                          {/* Only QC Performance button for Quality Manager */}
                          <button
...
export default QualityManagerSurveyReports;
